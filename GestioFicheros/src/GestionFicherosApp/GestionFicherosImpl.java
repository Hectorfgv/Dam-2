...
public class GestionFicherosImpl implements GestionFicheros {
	...
	public void creaCarpeta(String arg0) throws GestionFicherosException {
		...
		//que se pueda escribir -> lanzará una excepcióna
		if (!carpetaDeTrabajo.canWrite())  {
			throw new GestionFicherosException("No tienes permiso para crear aquí");
		}
		//que no exista -> lanzará una excepción
		if (file.exists()) {
			throw new GestionFicherosException("Esa carpeta ya existe");
		}
		//crear la carpeta -> lanzará una excepción
		if (!file.mkdir()) {
			throw new GestionFicherosException("La carpeta no se ha podido crear");
		}
	...
	public void creaFichero(String arg0) throws GestionFicherosException {
		...
		//que se pueda escribir -> lanzará una excepcióna
			...
			//que no exista -> lanzará una excepción
			if (file.exists()) {
				throw new GestionFicherosException("Ese fichero ya existe");
			}
			//crear la carpeta -> lanzará una excepción
			try {
				file.createNewFile();
			
			} catch (IOException GestionFicherosException) {
				// TODO Auto-generated catch block
				throw new GestionFicherosException("El fichero no se ha podido crear");
			}
	...
	public void elimina(String arg0) throws GestionFicherosException {
		File file = new File(carpetaDeTrabajo,arg0);
		//permisos
		if (!carpetaDeTrabajo.canRead() || (!carpetaDeTrabajo.canWrite())) {
			throw new GestionFicherosException("No tienes permiso para borrar aquí");
		}
		//que no exista -> lanzará una excepción
		if (!file.exists()) {
			throw new GestionFicherosException("Ese archivo no existe");
		}
		if (!file.delete()) {
	...
	public String getInformacion(String arg0) throws GestionFicherosException {
		...
		if (!file.exists()) {
			throw new GestionFicherosException("Error. El archivo no existe.");
		}
		...
		SimpleDateFormat dmh = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
		strBuilder.append("Última modificación: ");
		strBuilder.append(dmh.format(file.lastModified()));
		strBuilder.append("\n");
	...
	public void renombra(String arg0, String arg1)
		...
		//permisos
		if (!carpetaDeTrabajo.canRead() || (!carpetaDeTrabajo.canWrite())) {
			throw new GestionFicherosException("No tienes permiso para renombrar aquí");
		}
		//que no exista -> lanzará una excepción
		if (!file.exists()) {
			throw new GestionFicherosException("Ese archivo no existe");
		...
		if (file2.exists()) {
			throw new GestionFicherosException("Ese archivo ya existe");
		}
